 ...
 * Description: Standalone architectural landing page for EverLine metal fencing.
 * Template Post Type: page
 *
 * Drop this file into your active WordPress theme or child theme.
 *
 * @package EverLine
 */

// Check if assets are in theme or fallback to current directory
$theme_uri = get_stylesheet_directory_uri();
$img_url = $theme_uri . '/assets/images/';
$phone = '(800) 728-4010';
...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo esc_url( $img_url . 'favicon.ico' ); ?>">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo esc_url( $img_url . 'apple-touch-icon.png' ); ?>">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@400;500;600;700;800;900&family=Roboto+Condensed:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo esc_url( $theme_uri . '/assets/css/theme.css' ); ?>">
  <?php wp_head(); ?>
</head>
...
<script src="<?php echo esc_url( $theme_uri . '/assets/js/theme.js' ); ?>"></script>
<?php wp_footer(); ?>
</body>
</html>
